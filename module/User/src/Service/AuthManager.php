...
class AuthManager
{
    ...
    /**
     * @access private
     * @var \Zend\Authentication\AuthenticationService $authService - Authentication service.
     */
    private $authService;

    /**
     * @access private
     * @var Zend\Session\SessionManager $sessionManager - Session manager.
     */
    private $sessionManager;

    /**
     * @access private
     * @var array  $config - Contents of the 'access_filter' config key.
     */
    private $config;
